...
<head>
    <meta charset="UTF-8">
    <title>Construction of Methods Material</title>
...
$topic = 'Construction of Methods'; 
$materialPath = 'curriculum_docs/OOP_Lessons/ConstructMethods.pdf'; 
$quizLink = 'home.php?page=exam&id=36'; 
