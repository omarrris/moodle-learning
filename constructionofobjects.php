...
<head>
    <meta charset="UTF-8">
    <title>Construction of Objects Material</title>
...
$topic = 'Construction of Objects'; 
$materialPath = 'curriculum_docs/OOP_Lessons/ConstructObjects.pdf'; 
$quizLink = 'home.php?page=exam&id=35'; 
