...
<head>
    <meta charset="UTF-8">
    <title>Interpretation of Concepts Material</title>
...
$topic = 'Interpretation of Concepts'; 
$materialPath = 'curriculum_docs/OOB_Lessons/InterpretationConcepts.pdf'; 
$quizLink = 'home.php?page=exam&id=23'; 
